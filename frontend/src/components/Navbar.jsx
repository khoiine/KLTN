...
const Navbar = () => {
    ...
    const { setShowSearch, getCartCount, navigate, token, setToken, setCartItems, isAdmin, setIsAdmin, unreadCount } = useContext(ShopContext);
        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className='flex item-center gap-6'>
                ...
                <div className='relative'>
                    ...
                    />
                    {token && unreadCount > 0 && (
                        <span className='absolute -top-1 -right-2 w-4 text-center leading-4 bg-red-500 text-white aspect-square rounded-full text-[8px]'>
                    ...
                    {token &&
                        <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
                                ...
                                <p onClick={() => navigate('/change-password')} className='cursor-pointer hover:text-black'>Đổi mật khẩu</p>
